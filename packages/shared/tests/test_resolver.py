...
def test_resolve_no_provider_zero_exception():
    ...
    with patch.dict(os.environ, {}, clear=True):
        with pytest.raises(ValueError, match="Please set one of OPENROUTER_API_KEY, ANTHROPIC_API_KEY, or OPENAI_API_KEY"):
            resolve_model()
...
def test_resolve_env_precedence_boundary():
    ...
    with patch.dict(os.environ, {"OPENROUTER_API_KEY": "sk-or-...", "ANTHROPIC_API_KEY": "sk-ant-...", "OPENAI_API_KEY": "sk-oa-..."}):
        assert resolve_model().startswith("openrouter:")

    # 2. Anthropic (No OpenRouter)
    with patch.dict(os.environ, {"ANTHROPIC_API_KEY": "sk-ant-...", "OPENAI_API_KEY": "sk-oa-..."}, clear=True):
...
def test_resolve_provider_default_overrides_boundary():
    ...
    with patch.dict(os.environ, {
        ...
        "DEFAULT_MODEL_OPENAI": "openai:gpt-4-turbo-preview"
    }, clear=True):
    ...
    with patch.dict(os.environ, {
        ...
        "DEFAULT_MODEL_ANTHROPIC": "anthropic:claude-3-opus"
    }, clear=True):
